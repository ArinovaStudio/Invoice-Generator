      ...
      <div className="w-full max-w-md p-8 bg-white/80 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 rounded-2xl z-10 relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isLoading || isGoogleLoading || isOtpStep}
                required
              />
            </div>
          </div>
          ...
          {step === "verify_otp" && (
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="flex h-11 w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                required
              />
            </div>
          )}
          ...
          <button
            ...
            className="text-sm w-full flex items-center justify-center h-11 bg-[#FF4F33] hover:bg-[#E6472E] text-white font-bold rounded-lg transition-all shadow-md shadow-orange-500/20 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading ? (
