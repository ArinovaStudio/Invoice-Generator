    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 relative overflow-hidden py-12">
      ...
      <div className="w-full max-w-md p-8 bg-white/80 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 rounded-2xl z-10 relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-2 font-medium">Start generating invoices in seconds</p>
        </div>
        ...
        <div className="mt-8 mb-6 flex items-center justify-center space-x-4">
          ...
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-400">Or register with</span>
          <div className="flex-1 h-px bg-slate-200"></div>
        </div>
