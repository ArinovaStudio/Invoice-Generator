...
export default function PayPage() {
  ...
  return (
    <>
      <div className="sm:min-h-[80vh] pt-14 pb-10 md:pb-18 md:pt-32 min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-white px-4">
        <Navbar />
